...
```bash
git clone https://github.com/ntclick/spingamefhe.git
cd spingamefhe
```
...
- **Issues**: [GitHub Issues](https://github.com/ntclick/spingamefhe/issues)
- **Discussions**: [GitHub Discussions](https://github.com/ntclick/spingamefhe/discussions)
