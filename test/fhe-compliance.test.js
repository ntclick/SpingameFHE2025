...
describe("FHE Compliance Tests", function () {
  ...
  describe("FHE Contract Deployment", function () {
    ...
    it("Should have correct FHE contract structure", async function () {
      ...
      expect(await luckySpin.buyGmTokensFHE).to.be.a("function");
      expect(await luckySpin.publishScore).to.be.a("function");
      expect(await luckySpin.getUserSpins).to.be.a("function");
      expect(await luckySpin.getUserGmBalance).to.be.a("function");
    });
  });
